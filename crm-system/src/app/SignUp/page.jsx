...
const SignUp = () => {
  ...
  return (
    <div className="flex pt-5 bg-gray-100 items-center justify-center min-h-screen">
      <div className="bg-white p-8 shadow-lg rounded-lg w-full max-w-4xl mx-4 md:mx-8 lg:mx-auto">
